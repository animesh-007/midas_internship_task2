...
def main():
    ...
    parser.add_argument('--midas_digits', action='store_false', default=True,
                        help='For training on subset of midas digits dataset')
    ...
    if args.midas_digits:
        print("==> Loading Midas digits dataset") 
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.train:
            ...
            train(args, midas_model, device, train_loader, optimizer, epoch,criterion)
